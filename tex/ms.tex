...
\ha\ (median offsets of $+0.006$ and $-0.029$~dex and NMAD scatter of
0.022 and 0.020~dex), but \oiiilam\ and \hb\ show larger offsets
($+0.115$ and $-0.085$~dex, respectively). Agreement with the DR1
catalog of H.~Zou et~al., (in preparation) is excellent in median
offset ($|\Delta_{\rm med}|<0.01$~dex) and scatter
($\mathrm{NMAD}<0.04$~dex) for all four lines.
...
lines are systematically narrower than a unit Gaussian (NMAD of
0.29--0.71), indicating that the combined quoted flux uncertainties
