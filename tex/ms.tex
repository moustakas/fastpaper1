...
\todo{Not a great paragraph. In fact, the whole rest of this section
  is not great.} Narrow-line bounds are $1 < \sigma < 750$~\kms{} and
$|\Delta v| < 500$~\kms; broad-line bounds are $1 < \sigma <
10{,}000$~\kms{} and $|\Delta v| < 2{,}500$~\kms. Within these groups,
most doublets---for example, \oiii~$\lambda$4959\,/\,$\lambda$5007 and
...
equation~(\ref{eq:zfactor}). The current stellar mass (in \msun),
therefore, is simply
\begin{equation}
  \Mstar = \mathcal{M}_0\sum_{n=1}^{n_\mathrm{template}} c_n\,f_{\star,n},
  \label{eq:mstar}
\end{equation}
...
\noindent where $f_{\star,n}\in(0,1]$ is the fraction of formed mass
  ...
  dividing by 100~Myr,
\begin{equation}
  \mathrm{SFR} = \frac{\mathcal{M}_0}{100\,\mathrm{Myr}}\sum_{n=1}^{2} c_n,
  \label{eq:sfr}
\end{equation}
\noindent in units of \msun/yr. Additional estimates of the SFR of
