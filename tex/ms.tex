...
DESI DR2, comprising 37 million extragalactic targets, along with
updated catalogs for the Early Data Release and Data Release 1,
document the code's computational performance, and validate the
measurements against independent codes (\S\ref{sec:vac}). We conclude
...
pipeline needed to interpret the \fastspecfit{} VACs; for a complete
description see \citet{desi-collaboration24e, desi-collaboration24d,
...
resulting DR2 VAC may skip to \S\ref{sec:vac}.
...
\begin{itemize}
  ...
  \item Note any QSO-specific after-burner redshift correction applied to
    this object (\S\ref{ssec:catalog})
\end{itemize}
...
EDR, 74,000 in DR1, and 165,000 in DR2.
...
\noindent where \texttt{VACDIR} is the top-level VAC directory. We make all
catalogs publicly accessible via \url{https://data.desi.lbl.gov}.
