...
\caption{Comparison of \fastspecfit{} stellar masses with three
  ...
  DR2 photometry, (middle) \citet{siudek25a} using CIGALE SED fitting
  with AGN contributions fit to DR1 spectra and photometry, and
  (bottom) \citet{salim16a,salim18a} using CIGALE SED fitting of
  ...
  (external minus \fastspecfit{}) in dex, and the \texttt{NMAD}
  scatter. The dashed line is the 1:1
  relation.\label{fig:compare-mstar-external}}
\end{figure*}
...
stellar masses from \fastspec{} against three independent CIGALE-based
SED-fitting catalogs. \todo{Describe agreement; highlight systematic
  offsets from non-parametric vs. parametric SFH choices.} We caution
that non-parametric SFH models can yield stellar masses that are
